...
TEST_START, TEST_END = "2024-03-18", "2024-03-24"
OUT_DIR = Path("results/keirin_shogi/v9_inverted_participation/2024-03-18_2024-03-24")
...
def main():
    ...
    summary={
        ...
        "leakage_guard":"2024-03-18以降の結果は学習・参加判定に未使用。オッズ不使用。"
    }
