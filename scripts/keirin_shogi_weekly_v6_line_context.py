...
TRAIN_START, TRAIN_END = "2024-01-22", "2024-01-28"
TEST_START, TEST_END = "2024-01-29", "2024-02-04"
OUT_DIR = Path("results/keirin_shogi/v6_line_context/2024-01-29_2024-02-04")
...
def main():
    ...
    summary={
        ...
        "method":"v5の順位ベクトル＋相対差を維持し、line_id/line_sizeから同ライン平均・最大得点、B合計、逃げ+捲り合計、本人とライン最大得点差、自ライン最大得点と他ライン最大得点差、自ライン総合力と他ライン総合力差、単騎フラグを関係特徴として追加。line_positionや役割固定ルールは不使用。1/22-1/28学習、1/29-2/4固定検証。",
        "leakage_guard":"2024-01-29以降の結果は学習に未使用。オッズ不使用。"
    }
