...
final={
 ...
 "frozen_policy":{"max_candidate_count":cfg["max_candidate_count"],"target_fraction":cfg["target_fraction"]},\n "selector_model":{"feature_order":["top1_prob","prob_gap12","prob_sum12","selected_candidate_prob_mass","entropy","top1_model_agreement_ratio","candidate_count_ratio","top1_model_prob_sd"],"intercept":float(clf.intercept_[0]),"coefficients":[float(x) for x in clf.coef_[0]]},
