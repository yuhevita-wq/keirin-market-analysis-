...
OUT=ROOT/"results/keirin_shogi/kyodo_2025_history_h5_test.json"
...
START,END="2025-09-12","2025-09-13"
STAKE=100
...
def main():
    ...
    scored,rules,cal_n=w.build_forward_scored(races,2025)
    rows=[]
    for r in scored:
        race=r["race"]
    ...
    report={
        "study":"2025 Kyodo days1-2 fixed H1-H4 plus provisional H5 cumulative relation cut",
        "dates":[START,END],
        "definition":{
