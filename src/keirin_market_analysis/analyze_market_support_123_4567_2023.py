...
OUT = ROOT / 'data' / 'audits' / 'market_support_1_23_4567_2023.json'
STAKE = 100
...
def main():
    ...
    out = {
        'status': 'MARKET_SUPPORT_1_23_4567_2023',
        'year': 2023,
        'years_read': [2023],
        ...
        'formation': 'trio market support rank 1 - ranks 2,3 - ranks 4,5,6,7',
        'strategy_detail': 'Exactly 8 tickets in a 7-rider race: rank1-rank2-tail4to7 and rank1-rank3-tail4to7. No rank1-rank2-rank3 ticket.',
