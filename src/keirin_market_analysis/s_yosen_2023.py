...
def collect(start: date, end: date, out_dir: Path, sleep_seconds: float) -> dict[str, object]:
    """Collect 2023 races using the exact same parsing logic as the frozen 2025 collector."""
    ...
    summary = {
        ...
        "oos_note": "2023 is the fresh out-of-sample validation year for V2. Collection/parsing logic is inherited unchanged from the frozen 2025 collector. V2 must not be altered after reading 2023 outcomes.",
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect all exact-label S-class preliminary race cards for 2023")
    parser.add_argument("--start-date", default="2023-01-01")
    parser.add_argument("--end-date", default="2023-12-31")
    parser.add_argument("--out-dir", default="data/2023/s_class_yosen")
