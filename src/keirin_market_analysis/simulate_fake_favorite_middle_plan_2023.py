...
YEAR = 2023
OUT = Path('data/audits/fake_favorite_middle_plan_2023.json')

# All thresholds below were already surfaced by the earlier 2023 discovery audits.
# This script does not search or retune thresholds.
FAKE_GATES = {
...
def main():
    ...
    # A compact view sorted only for presentation; thresholds remain fixed.
    ...
    out = {
        'status': 'FAKE_FAVORITE_MIDDLE_PLAN_2023_EXPLORATORY_SIMULATION',
        'year': YEAR,
        'years_read': [2023],
        ...
        'discipline': 'No threshold search in this script. Fake-favorite and middle thresholds are reused exactly from previously completed 2023 discovery audits. Results are still in-sample for 2023 and are not proof of forward edge.',
