...
OUT=Path('data/audits/selected_234_236_246_2023.json')
STAKE=100
...
TARGET_PATTERNS=((2,3,4),(2,3,6),(2,4,6))
...
def main():
    ...
    out={'status':'SELECTED_234_236_246_2023_SAME_GATE','year':2023,'years_read':[2023],
      'thresholds':{'entropy_min':ENTROPY_MIN,'top3_conc_max':TOP3_CONC_MAX,'p123_max':P123_MAX,'rank1_share_min':RANK1_SHARE_MIN},
      'strategy':'Buy support-rank trios 2-3-4, 2-3-6, and 2-4-6, 100 yen each, only when the same frozen gate passes.',
      ...
      'warning':'2023 development-year comparison only. Gate unchanged; axis shifted from support rank 1 to support rank 2.'}
