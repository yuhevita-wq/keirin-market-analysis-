...
def main():
    ...
    result = {
        ...
        'scientific_note': (
            'v11.0-C01 context definitions are unchanged from Q1. Race-card context remains observational and does not alter v8.25 tickets.'
        ),
    }
