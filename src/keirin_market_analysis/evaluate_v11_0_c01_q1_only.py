...
def main():
    ...
    result = {
        ...
        'scientific_note': (
            'Race-card context is observational in v11.0-C01 and does not alter v8.25 tickets. '
            'Any context split seen in Q1 is diagnostic only and must not be promoted to a buy/no-buy rule from Q1 alone.'
        ),
    }

    print('V11_0_C01_Q1_ONLY_BEGIN')
    print(json.dumps(result, ensure_ascii=False, indent=2))
    print('V11_0_C01_Q1_ONLY_END')
